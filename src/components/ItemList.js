      ...
      {items.map((dish) => (
        ...
        >
          ...
          <div className="relative w-48 h-40">
            ...
            />
            <button className="absolute bottom-0.5 left-1/2 transform -translate-x-1/2 bg-white text-green-600 font-bold text-xl px-10 py-1.5 rounded-xl border border-green-600 shadow-lg hover:bg-gray-100 focus:ring-2 focus:ring-green-500 focus:outline-none"
